...
<%@page import="com.chinasofti.dao.*"%>
		...
		<table border="0" width="950" height="350" bgcolor="#ffffff"
			...
			<tr>
				<td align="center" valign="top">
					...
					<form name="form1" method="post" action="../updatedept">
						<table width="500" border="0" cellpadding="5" cellspacing="1"
							...
							<tr>
								...
								<td height="24" bgcolor="#FFFFFF">
									<input name="dname" type="text" id="department_name"
										value="<%=dept.getdName()%>">
									*
								</td>
							</tr>
							<tr>
								...
								<td height="24" bgcolor="#FFFFFF">
									<input name="dloc" type="text" id="location_name"
										value="<%=dept.getdLoc()%>">
									*
								</td>
							</tr>
